...
ActiveRecord::Schema[7.1].define(version: 2025_06_03_070923) do
  ...
  create_table "casts", force: :cascade do |t|
    ...
    t.index ["api_cast_id"], name: "index_casts_on_api_cast_id", unique: true
  end
  ...
  add_foreign_key "characters", "casts"
